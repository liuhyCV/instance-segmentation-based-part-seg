...
int main()
{
	...
	*/
	...
	Mat Image_data = imread("/home/csc302/workspace/liuhy/gSLICr/000058.jpg", -1);
	...
	//{
		...
		//{
			...
			sprintf(out_name, "/home/csc302/workspace/liuhy/gSLICr/edge_%04i.png", save_count);
			imwrite(out_name, boundry_draw_frame);
			sprintf(out_name, "/home/csc302/workspace/liuhy/gSLICr/img_%04i.png", save_count);
